...
| Research workflow | Molemo WorkBench v0.19 | Current boundary |
| --- | --- | --- |
...
| Process benchmark | Implemented | Deterministic v0.19 suite including real local BLAST+, HMMER, PyDESeq2 and Scanpy/Scrublet/Leiden tasks, routing, approval boundary, provenance and artifacts |
