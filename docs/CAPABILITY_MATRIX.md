...
| Research workflow | Molemo WorkBench v0.12 | Current boundary |
| --- | --- | --- |
...
| Process benchmark | Implemented | Deterministic v0.12 suite including real local BLAST+, HMMER and PyDESeq2 tasks, VCF/target/literature/clinical-trial/variant routing, approval boundary and artifacts |
