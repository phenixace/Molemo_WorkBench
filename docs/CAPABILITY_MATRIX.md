...
| Guided plans and researcher approval | Implemented | Twenty-two concrete templates; Agent may propose and inspect, while only the local UI can approve execution |
...
| Process benchmark | Implemented | Deterministic v0.22 suite including real local BLAST+, HMMER, MAFFT, PyDESeq2 and Scanpy/Scrublet/Leiden tasks, routing, approval boundary, provenance and artifacts |
